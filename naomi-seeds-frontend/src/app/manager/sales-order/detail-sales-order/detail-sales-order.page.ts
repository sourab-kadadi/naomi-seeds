...
export class DetailSalesOrderPage implements OnInit {
  ...
  getAllSalesOrder() {
    ...
    this.route.paramMap.subscribe((paramMap) => {
      ...
      this.salesOrderSub = this.salesService
        .getSalesOrderById(paramMap.get('salesOrderId'))
        .subscribe(
          (res) => {
            ...
            console.log('last', this.isLoading);
          },
          (error) => {
            this.isLoading = false;
            this.inActive = true;
  ...
  onApproveByManagerDC() {
        this.isLoading = true;
    this.inActive = true;
    this.ngxUiLoader.startLoader('loader-detail');
    this.salesService
      .approveByManagerDC(this.salesOrderId)
      .subscribe(
        (res) => {
  ...
  onApproveByManagerFinalSales() {
    this.isLoading = true;
    this.inActive = true;
    this.ngxUiLoader.startLoader('loader-detail');
    this.salesService
      .approveByManagerFinalSales(this.salesOrderId)
      .subscribe(
        (res) => {
          this.approved = res.data;
                      this.isLoading = false;
  ...
  onApproveByManagerFinalIPT() {
    this.isLoading = true;
    this.inActive = true;
    this.ngxUiLoader.startLoader('loader-detail');
    this.salesService
      .approveByManagerFinalIPT(this.salesOrderId)
      .subscribe(
        (res) => {
          this.approved = res.data;
                      this.isLoading = false;
