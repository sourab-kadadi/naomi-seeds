...
export class PermissionCanDeleteGuard implements CanActivate {
  ...
  canActivate(
    ...
    this.permissionsDataBehaviourSubjectService.permissionsDataObservable.subscribe((res) => {
      if (res.permissionsDatapoints[route.data.pageLocation].CAN_DELETE === route.data.permissions.CAN_DELETE === true) {
