...
export class PermissionCanCreateGuard implements CanActivate {
...
if (res.permissionsDatapoints[route.data.pageLocation].CAN_CREATE === route.data.permissions.CAN_CREATE === true) {
